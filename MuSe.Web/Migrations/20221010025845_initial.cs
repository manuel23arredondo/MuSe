        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InsideNumber = table.Column<string>(maxLength: 50, nullable: false),
                    OutsideNumber = table.Column<int>(nullable: false),
                    Colony = table.Column<string>(maxLength: 50, nullable: false),
                    PostCode = table.Column<int>(maxLength: 6, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CodeTemp", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CodeTemp_MonitorWomen_MonitorWomanId",
                        column: x => x.MonitorWomanId,
                        principalTable: "MonitorWomen",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CodeTemp_Womans_WomanId",
                        column: x => x.WomanId,
                        principalTable: "Womans",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CodeTemp_MonitorWomanId",
                table: "CodeTemp",
                column: "MonitorWomanId");

            migrationBuilder.CreateIndex(
                name: "IX_CodeTemp_WomanId",
                table: "CodeTemp",
                column: "WomanId");
