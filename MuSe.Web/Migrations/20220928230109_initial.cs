    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OwnWomanPlace", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OwnWomanPlace_KindOfPlaces_KindOfPlaceId",
                        column: x => x.KindOfPlaceId,
                        principalTable: "KindOfPlaces",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OwnWomanPlace_Womans_WomanId",
                        column: x => x.WomanId,
                        principalTable: "Womans",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WomanMonitors", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WomanMonitors_Monitors_MonitorId",
                        column: x => x.MonitorId,
                        principalTable: "Monitors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_WomanMonitors_Womans_WomanId",
                        column: x => x.WomanId,
                        principalTable: "Womans",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OwnWomanPlace_KindOfPlaceId",
                table: "OwnWomanPlace",
                column: "KindOfPlaceId");

            migrationBuilder.CreateIndex(
                name: "IX_OwnWomanPlace_WomanId",
                table: "OwnWomanPlace",
                column: "WomanId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WomanMonitors_MonitorId",
                table: "WomanMonitors",
                column: "MonitorId");

            migrationBuilder.CreateIndex(
                name: "IX_WomanMonitors_WomanId",
                table: "WomanMonitors",
                column: "WomanId");
